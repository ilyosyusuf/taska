...
class ProfilePage extends StatelessWidget {
          ...
          Expanded(
            ...
            child: Column(
              children: [
                ...
                listTile(Icon(FontAwesomeIcons.user), "Edit Profile",
                    onPressed: () {
                ...
                listTile(Icon(FontAwesomeIcons.signOutAlt), "Logout",
  ...
  ListTile listTile(Icon icon, String text,
          {VoidCallback? onPressed, Switch? trailing, Color? color}) =>
      ListTile(
          leading: icon,
          title: Text(
            text,
